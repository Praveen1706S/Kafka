...
public class KafkaConsumerConfiguration {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.appsdeveloperblog.ws.emailnotification.config.ProductCreatedEvent");
    ...
    @Bean
    KafkaTemplate<String, Object> KafkaTemplte(ProducerFactory<String, Object> producerFactory){
